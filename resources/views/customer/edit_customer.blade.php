    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- Code Here.... -->
                    <div class="row">
                    	<form action="{{URL::to('/updatecustomer')}}" method="POST">
                        <div class="col-md-12">
                            ...
                            <div class="change_passport_body" style="width: 80% !important;background-color: #18352600;">
                                ...
                                <p class="form_title_center">
                                	...
                                	<input type="hidden" class="form-control" name="hiddenproductid" value="{{$edit_company->id}}" autocomplete="off" required >
